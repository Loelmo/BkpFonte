...
namespace Sistema_de_Gestao
{
    public partial class RelatorioEstatisticoInscritas : PaginaBase
    {
        ...
        {
            UCFiltroRanking1.Relatorio = Sistema_de_Gestao.User_Controls.UCFiltroRanking.enumRelatorio.RelatorioEstatisticoInscritas;
        }
        ...
        {
            RelFiltroRanking objFiltroRanking = UCFiltroRanking1.GetFiltro(0);
