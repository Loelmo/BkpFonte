...
namespace Sistema_de_Gestao.FGA.Paginas
{
    public partial class RelatorioNumeroParticipantesPorEtada : PaginaBase
    {
        ...
        {
            UCFiltroRanking1.Relatorio = Sistema_de_Gestao.User_Controls.UCFiltroRanking.enumRelatorio.RelatorioParticipantesPorEtapa;
        }
        ...
        private void PopulaGridPorEstado()
        {
            ...
            List<RelParticipantesPorEtapa> Lista = new BllRelatorio().ObterParticipantesPorEtapaPorEstado(objRelFiltroRanking);
