<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVisualizaEmpresaTurmaCE.ascx.cs" Inherits="Sistema_de_Gestao.FGA.User_Controls.UCVisualizaEmpresaTurmaIA" %>
  ...
  <div id="divUserControl" runat="server" visible="false" valign="middle" align="center"
    ...
    <asp:Panel ID="PnlFundo" CssClass="panelUC" runat="server">
        ...
        <fieldset>
            <legend style="font-size: large">Filtros - <asp:Label ID="lblTurma" runat="server" /></legend>
            <br />
            <table cellspacing="1" cellpadding="1" width="100%" border="0" style="text-align: left;" class="tabFiltros">
                <tr>
                    <td>
                        <asp:Label ID="lblCnpjCpf" runat="server" Text="CNPJ:"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="LblCategoria" runat="server" Text="Setor:"> </asp:Label>
                    </td>
                    <td>
            ...
            <fieldset>
                ...
                <table cellspacing="1" cellpadding="1" width="100%" align="center" border="0">
                  <tr>
                    <td align="right"> 
                         <asp:ImageButton ID="ImgBtnIncluir" runat="server"  Visible="false"
                                ...
                                <asp:GridView ID="grdEmpresasCadastradas" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Trocar Turma">
                                        ...
                                        <asp:TemplateField HeaderText="Inativar na Turma" Visible="false">
                                           <ItemTemplate>
