...
//                MessageBox(this, "Cadastro não localizado, faça sua Inscrição!");
        ...
        protected void ImgBtnProcessar_Click(object sender, ImageClickEventArgs e)
        {
                if (VerificaCamposObrigatorios())
                {
                    ...
                    {
                        this.Gravar(false);
                        divJustificativa.Style.Add("display", "block");
                    }
                    else
                    {
                        this.Gravar(true);
        ...
        private void PopulaEstado()
        {
            ...
            List<EntEstado> listEstado = new BllEstado().ObterEstadosPorTurma(objTurma.IdTurma, EntTipoEtapa.TIPO_ETAPA_FGA_INSCRICAO_AUTODIAGNOSTICO_EMPRESA);
