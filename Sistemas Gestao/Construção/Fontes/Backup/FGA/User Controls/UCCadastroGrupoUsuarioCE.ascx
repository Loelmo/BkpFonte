<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCadastroGrupoUsuarioCE.ascx.cs" Inherits="Sistema_de_Gestao.User_Controls.UCCadastroGrupoUsuarioCE" EnableViewState="true"%>
