<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCadastroTurmaIAAddQuestionario.ascx.cs" Inherits="PEG.FGA.User_Controls.UCCadastroTurmaIAAddQuestionario" %>
