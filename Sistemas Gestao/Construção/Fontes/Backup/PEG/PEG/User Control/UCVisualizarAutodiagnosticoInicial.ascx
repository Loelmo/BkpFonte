<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVisualizarAutodiagnosticoInicial.ascx.cs" Inherits="PEG.FGA.User_Controls.UCVisualizarAutodiagnosticoInicial" %>
