<%@ Page Title="Cadastro Inscrição Empresa" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="CadastroInscricoesEmpresa.aspx.cs" Inherits="PEG.Paginas.CadastroInscricoesEmpresa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset runat="server" id="Etapa1">
        ...
        <table cellspacing="1" cellpadding="1" align="center" border="0" class="tabFiltros">
            ...
            <tr>
                <td>
                    <asp:Label ID="LblCPF_CNPJ" runat="server" Text="CNPJ / CPF:"></asp:Label>
                </td>
                <td>
    ...
    <fieldset runat="server" id="Etapa3" visible="false">
        ...
        <table style="vertical-align: top;">
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="Button11" runat="server" Text="Voltar" OnClick="BtnVoltar3_Click"
