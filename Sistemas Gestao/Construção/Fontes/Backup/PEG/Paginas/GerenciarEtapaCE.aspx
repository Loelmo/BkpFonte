<%@ Page Title="Gerenciar Etapa" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="GerenciarEtapaCE.aspx.cs" Inherits="PEG.Paginas.GerenciarEtapaCE" %>
            ...
            <tr>
                ...
                <td Style="width: 200px">
                        ...
                        <asp:RequiredFieldValidator ID="rfvEstado" runat="server" ControlToValidate="DrpDwnLstEstado"
                            ErrorMessage="Estado Obrigatório!" ValidationGroup="vgPesquisar" Display="None" InitialValue="0"
                            SetFocusOnError="true"></asp:RequiredFieldValidator>
                        <cc3:ValidatorCalloutExtender ID="vcEstado" runat="server" TargetControlID="rfvEstado">
                ...
                <td>
                    <asp:ImageButton ID="ImgBttnPesquisar" runat="server" ImageUrl="~/Image/file_search2.png"
                        Style="width: 20px" OnClick="ImgBttnPesquisar_Click" ValidationGroup="vgPesquisar"  />
                </td>
            </tr>
        </table>
    </fieldset>
