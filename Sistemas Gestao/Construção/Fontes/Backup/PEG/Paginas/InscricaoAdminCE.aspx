<%@ Page Title="Inscrições" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="InscricaoAdminCE.aspx.cs" Inherits="PEG.Paginas.InscricaoAdminCE" %>
...
<%@ Register Src="~/User Controls/UCInscricaoEmpresaIA.ascx" TagName="UCInscricaoEmpresaIA"
    TagPrefix="uc2" %>
<%@ Register Src="~/PEG/User Control/UCHistoricoRAA.ascx" TagName="UCHistoricoRAA"
    TagPrefix="uc3" %>
