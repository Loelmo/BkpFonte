...
namespace PEG.User_Controls
{
    public partial class UCPerguntaMultiplaEscolha4Opcoes : UCQuestionarioBase
    {
        ...
        protected void BtnJustificativaSalvar_Click(object sender, EventArgs e)
        {
            Gravar();
            ...
            this.coluna1RespostaA.Style.Add("background-color", "#E1EEEE");
            this.coluna2RespostaA.Style.Add("background-color", "#E1EEEE");
            this.respostaA.Style.Add("background-color", "#E1EEEE");
            this.coluna1RespostaB.Style.Add("background-color", "#E1EEEE");
            this.coluna2RespostaB.Style.Add("background-color", "#E1EEEE");
            this.respostaB.Style.Add("background-color", "#E1EEEE");
            this.coluna1RespostaC.Style.Add("background-color", "#E1EEEE");
            this.coluna2RespostaC.Style.Add("background-color", "#E1EEEE");
            this.respostaC.Style.Add("background-color", "#E1EEEE");
            this.coluna1RespostaD.Style.Add("background-color", "#E1EEEE");
            this.coluna2RespostaD.Style.Add("background-color", "#E1EEEE");
            this.respostaD.Style.Add("background-color", "#E1EEEE");
