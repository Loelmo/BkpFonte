<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCExportarCandidataEstadual.ascx.cs" Inherits="PEG.User_Controls.UCExportarCandidataEstadual" %>
...
<div id="divUserControl" runat="server" visible="false" valign="middle" align="center"
    ...
    <asp:GridView ID="grdCanditadaEstadual" runat="server" AllowPaging="True" AllowSorting="True" Visible="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Avaliador Senior" Visible="False">
                                    <ItemTemplate>
