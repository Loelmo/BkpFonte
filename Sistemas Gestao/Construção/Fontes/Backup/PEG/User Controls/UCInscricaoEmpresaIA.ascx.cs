...
namespace PEG.User_Control
{
    public partial class UCInscricaoEmpresaIA : UCBase
    {
        ...
        private void PopulaEstado()
        {
            ...
            Int32 IdTipoEtapa = EntTipoEtapa.TIPO_ETAPA_FGA_INSCRICAO_AUTODIAGNOSTICO_ADMINISTRATIVO;
        ...
        private void PopulaTipoEmpresa()
        {
            ...
            this.CmbBxTipoEmpresa.DataSource = new BllTipoEmpresa().ObterTodosFga();
        ...
        private void PopulaCategoria(Boolean isCpf)
        {
            ...
            this.CmbBxCategoria.DataSource = new BllCategoria().ObterTodosFga(true);
