...
namespace Sistema_de_Gestao.Paginas
{
    public partial class InscricaoAdminCE : PaginaBase
    {
        ...
        private void PopulaStatus()
        {
            ...
            item = new ListItem();
            item.Text = "Candidata Estadual";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_CLASSIFICACAO_ESTADUAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Classificada
            item = new ListItem();
            item.Text = "Classificada Estadual";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_AVALIACAO_ESTADUAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Finalista
            item = new ListItem();
            item.Text = "Finalista Estadual";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_JULGAMENTO_FINALISTAS_ESTADUAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Candidata
            item = new ListItem();
            item.Text = "Vencedora Estadual";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_CLASSIFICACAO_NACIONAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Candidata
            item = new ListItem();
            item.Text = "Candidata Nacional";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_CLASSIFICACAO_NACIONAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Classificada
            item = new ListItem();
            item.Text = "Classificada Nacional";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_AVALIACAO_NACIONAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Finalista
            item = new ListItem();
            item.Text = "Finalista Nacional";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_JULGAMENTO_FINALISTAS_NACIONAL.ToString();
            ddlStatus.Items.Add(item);

            //Insere Item Candidata
            item = new ListItem();
            item.Text = "Vencedora Nacional";
            item.Value = EntTipoEtapa.TIPO_ETAPA_MPE_ENCERRAMENTO_NACIONAL.ToString();
            ddlStatus.Items.Add(item);
        }
