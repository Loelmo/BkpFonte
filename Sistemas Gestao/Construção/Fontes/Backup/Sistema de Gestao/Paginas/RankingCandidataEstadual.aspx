<%@ Page Title="Candidatas" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="RankingCandidataEstadual.aspx.cs" Inherits="Sistema_de_Gestao.Paginas.RankingCandidataEstadual" %>
...
<%@ Register Src="~/MPE/User Control/UCJustificativaRanking.ascx" TagName="UCJustificativaRanking"
    TagPrefix="uc3" %>
<%@ Register Src="~/FGA/User Controls/UCVisualizarAutodiagnosticoInicial.ascx" TagName="UCVisualizarAutodiagnosticoInicial"
    TagPrefix="uc4" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="IdEtapa" Visible="False">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblNumeroFuncionarios" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "NumeroFuncionarios")%>'></asp:Label>
                                        <asp:Label ID="lblDataAbertura" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DataAbertura")%>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Avaliadores" Visible="False">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIdAvaliadorSenior" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "IdAvaliadorSenior")%>'></asp:Label>
                                        <asp:Label ID="lblNomeAvaliadorSenior" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "NomeAvaliadorSenior")%>'></asp:Label>
                                        <asp:Label ID="lblIdAvaliadorAcompanhante" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "IdAvaliadorSenior")%>'></asp:Label>
                                        <asp:Label ID="lblNomeAvaliadorAcompanhante" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "NomeAvaliadorSenior")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Avaliadores">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Desclassificar">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Total Responsabilidade Social">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkTotalResponsabilidadeSocial" Visible="false" runat="server"
                                            Checked='<%# Vinit.SG.Common.ObjectUtils.ToBoolean(DataBinder.Eval(Container.DataItem, "PossuiResponsabilidadeSocial"))%>' />
                                        <asp:Label ID="LblTotalResponsabilidadeSocial" runat="server" Text='<%# Vinit.SG.Common.FormatUtils.FormatPontuacaoRanking((double) DataBinder.Eval(Container.DataItem, "PontuacaoTotalResponsabilidadeSocial"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="150px" BackColor="Goldenrod" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Pontuação Inovação">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkPontuacaoInovacao" Visible="false" runat="server" Checked='<%# Vinit.SG.Common.ObjectUtils.ToBoolean(DataBinder.Eval(Container.DataItem, "PossuiInovacao"))%>' />
                                        
                                        <asp:Label ID="LblPontuacaoInovacao" runat="server" Text='<%# Vinit.SG.Common.FormatUtils.FormatPontuacaoRanking((double) DataBinder.Eval(Container.DataItem, "PontuacaoInovacao"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="150px" BackColor="Goldenrod" />
                                </asp:TemplateField>
