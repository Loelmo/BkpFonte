alter PROCEDURE [dbo].[STP_SelecionaQuestionarioEmpresaAtivoPorQuestionarioEmpresaTurma]  
(  
...
INNER JOIN TBL_ETAPA e ON e.CDA_ETAPA = qe.CEA_ETAPA  
  WHERE qe.CEA_EMP_CADASTRO = @nCEA_EMP_CADASTRO AND qe.CEA_QUESTIONARIO= @nCEA_QUESTIONARIO  
     AND e.CEA_TURMA = @nCEA_TURMA AND QE.TX_PROTOCOLO IS NOT NULL AND QE.FL_ATIVO = 1  
