...
/*   
------------------------------------------------------------------------------------------      
Procedure...............: STP_SelecionaEmpresasInscritasAdministradorPorFiltro
Funcao..................:  
...
DECLARE @NAME_PROCEDURE VARCHAR(250) = 'STP_SelecionaEmpresasInscritasAdministradorPorFiltro'
...
ALTER PROCEDURE [dbo].STP_SelecionaEmpresasInscritasAdministradorPorFiltro
	@CEA_TIPO_ETAPA INT,    
	@CEA_TURMA INT,    
...
SET NOCOUNT ON  
	...
	WHERE
		((TE.CEA_USUARIO IS NULL) OR (TE.CEA_USUARIO = 0))
		AND TE.FL_ATIVO = 1 
