<%@ Page Title="Classificada Nacional" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true"
    CodeBehind="RankingClassificadaNacional.aspx.cs" Inherits="Sistema_de_Gestao.FGA.Paginas.RankingClassificadaNacional" %>
                                ...
                                <asp:TemplateField HeaderText="Finalista">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgBttnFinalista" runat="server" CommandName="FinalistaGestao"
                                            CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/Image/_file_download2.png" />
                                    </ItemTemplate>
