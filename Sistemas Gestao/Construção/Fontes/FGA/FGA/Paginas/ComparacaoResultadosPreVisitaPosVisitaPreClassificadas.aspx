<%@ Page Title="Comparação de Resultados Pré-Visita e Pós-Visita - Pré-Classificadas" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true" CodeBehind="ComparacaoResultadosPreVisitaPosVisitaPreClassificadas.aspx.cs" Inherits="FGA.FGA.Paginas.ComparacaoResultadosPreVisitaPosVisitaPreClassificadas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>
       <asp:Label ID="lblTitulo" runat="server" Text='Comparação de Resultados Pré-Visita e Pós-Visita - Pré-Classificadas'></asp:Label> 
    </h3>
    <fieldset>
                ...
                <td colspan="2">
                    <div style="width: 911px; overflow: auto">
                            <asp:GridView ID="grdRanking" runat="server" AllowPaging="True" AllowSorting="True"
                                PageSize="15" Width="2000" AutoGenerateColumns="False" OnRowDataBound="grdRanking_RowDataBound"
...
<%--                                    <asp:TemplateField HeaderText="Pontuação RA Total [100%]">
                                    ...
                                    <asp:TemplateField HeaderText="Pré-visita Liderança [15%]">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Pós-visita Liderança [15%]">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Pré-visita Estratégias [9%]">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Pós-visita Estratégias [9%]">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Pré-visita Informações [6%]">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Pós-visita Informações [6%]">
                                        <ItemTemplate>
...
<%--                                    <asp:TemplateField HeaderText="RA Enfoque [70]">
                                        <ItemTemplate>
