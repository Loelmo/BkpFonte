<%@ Page Title="Pré-Classificadas" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true"
    CodeBehind="RankingPreClassificadas.aspx.cs" Inherits="Sistema_de_Gestao.FGA.Paginas.RankingPreClassificadas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>
       <asp:Label ID="lblTitulo" runat="server" Text='Ranking Classificada Estadual'></asp:Label> 
    </h3>
    <fieldset>
