<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCadastroEmpresaTurmaIA.ascx.cs" Inherits="Sistema_de_Gestao.FGA.User_Controls.UCCadastroEmpresaTurmaIA" %>
