<%@ Page Title="Fase 3" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true"
    CodeBehind="RankingFase3.aspx.cs" Inherits="Sistema_de_Gestao.PEG.Paginas.RankingFase3" %>
                    ...
                    <div style="width: 929px; overflow: auto">
                        <asp:GridView ID="grdRanking" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Fase 4">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgBttnFinalista" runat="server" CommandName="Fase4"
                                            CommandArgument="<%# Container.DataItemIndex %>"
                                            ImageUrl="~/Image/_file_download2.png" />
                                    </ItemTemplate>
                                    <HeaderStyle Width="80px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Resumo da Fase 3">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgBttnResumoFase3" runat="server" CommandName="ResumoFase3" CommandArgument='<%# Container.DataItemIndex %>'
                                            ImageUrl="~/Image/_file_download2.png" />
                                    </ItemTemplate>
