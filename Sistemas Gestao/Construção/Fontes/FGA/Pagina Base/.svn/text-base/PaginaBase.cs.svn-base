...
namespace Sistema_de_Gestao.Pagina_Base
{
    public class PaginaBase : System.Web.UI.Page
    {
        ...
        protected EntEtapa verificaEtapaInscricaoAberta()
        {
            ...
            else
            {
                ...
                {
                    etapaInscricao = new BllEtapa().ObterPorTipoEtapaTurmaEstado(EntTipoEtapa.TIPO_ETAPA_FGA_FASE_4, objTurma.IdTurma, EmpresaLogada.Estado.IdEstado);
                }
            }
