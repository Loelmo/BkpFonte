<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true" CodeBehind="AlterarSenha.aspx.cs" Inherits="Sistema_de_Gestao.Paginas.AlterarSenha" %>
            ...
            <tr>
                ...
                <td width="80%">
                    ...
                    <asp:ImageButton ID="ImgBttnConfirma" runat="server" ImageUrl="~/Image/_file_save.png"
                        TabIndex="3" onclick="ImgBttnConfirma_Click"  />&nbsp;&nbsp;&nbsp;
