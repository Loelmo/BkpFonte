...
<fieldset>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Label ID="LblEnviaQuestionario" Text="Para reenviar o seu autodiagnóstico, caso tenha feito alguma alteração, selecione a opção: Reenviar." runat="server" Font-Bold="true"/>
                <asp:Label ID="LblEnviaQuestionario2" Text="Para reenviar o seu autodiagnóstico, caso tenha feito alguma alteração, selecione a opção: Reenviar." runat="server" Font-Bold="true" Visible="false"/><br />
