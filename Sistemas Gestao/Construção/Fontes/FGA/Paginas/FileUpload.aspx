<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUpload.aspx.cs" Inherits="Sistema_de_Gestao.Paginas.FileUpload" %>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:ImageButton ID="imgBttnUpload" runat="server"
