<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCadastroSucesso.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCCadastroSucesso" %>
    ...
    <asp:Panel ID="PnlFundo" runat="server" Width="825px" Height="210px" BackColor="Transparent"
        BorderColor="Black" Style="position: relative; top: 10%;">
                <table class="DivTable" cellspacing="1" cellpadding="1" width="100%" align="center"
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label1" runat="server" Text="Ao longo do preenchimento você poderá esclarecer dúvidas conceituais sobre as questões e os critérios e incluirá informações adicionais para algumas das alternativas escolhidas. Estas informações auxiliarão na seleção das empresas para o Programa FGA."></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
