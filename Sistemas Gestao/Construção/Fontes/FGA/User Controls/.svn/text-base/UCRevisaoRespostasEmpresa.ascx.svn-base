<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRevisaoRespostasEmpresa.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCRevisaoRespostasEmpresa" %>
                    ...
                    <td>
                        <div align="center">
                            <asp:GridView ID="grdEtapaEstadual" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                OnRowDataBound="grdEtapaEstadual_RowDataBound" 
