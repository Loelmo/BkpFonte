<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAdministrativoEmpreendedorismo.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCAdministrativoEmpreendedorismo" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="850px">
        <tr>
            <td width="20%" valign="top" align="center">
                <asp:ImageButton TabIndex="120" ImageUrl="/Image/_file_back2.png" ID="ImageButton1" runat="server" OnClick="BtnVoltar_Click" />
            </td>
            <td class="justificativa" width="60%" align="center">
            </td>
            <td width="20%" valign="top" align="center">
                <div id="botaoProximo" runat="server">
                    <asp:ImageButton ImageUrl="/Image/_file_save.png" ID="BtnSalvar" runat="server" OnClick="BtnSalvar_Click" TabIndex="119"/>
                </div>
            </td>
        </tr>
    </table>
