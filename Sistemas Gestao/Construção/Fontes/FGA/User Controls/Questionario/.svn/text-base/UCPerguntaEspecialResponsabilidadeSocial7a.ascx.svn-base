<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPerguntaEspecialResponsabilidadeSocial7a.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCPerguntaEspecialResponsabilidadeSocial7a" %>
...
<div class="divPerguntas" id="divPerguntas" style="display: block;" runat="server">
    ...
    <table width="100%" cellpadding="10" cellspacing="0" border="0">
        ...
        <tr>
            <td style="width:480px;font-weight:bold;">Atividade
            </td>
            <td style="width:180px;font-weight:bold;">Quantidade
            </td>
        </tr>
        <tr>
            <td>
