<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaRelatorio.aspx.cs"
    Inherits="PEG.Paginas.PaginaRelatorio" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaCliente"
    TagPrefix="uc1" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaSociedade"
    TagPrefix="uc2" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaLideranca"
    TagPrefix="uc3" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaEstrategia"
    TagPrefix="uc4" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaPessoas"
    TagPrefix="uc5" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaProcessos"
    TagPrefix="uc6" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaInformacaoConhecimento"
    TagPrefix="uc7" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaResultado"
    TagPrefix="uc8" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaResponsabilidadeSocial"
    TagPrefix="uc9" %>
<%@ Register Src="~/PEG/User Control/UCRelatorioPergunta.ascx" TagName="UCRelatorioPerguntaInovacao"
    TagPrefix="uc10" %>
    ...
    <div align="left" class="style2" style="width: 859px">
            ...
            <div align="center" id="GraficoRadar">
                <table width="500" cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#8B8989" style="font-size: 12px; color: white" id="coluna1Fase4" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="center" bgcolor="#f0f0f0" id="coluna2Fase4" runat="server">
                        ...
                        <td colspan="4">
                            <asp:GridView ID="grdDesempenhoEmpresaGestao" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Pontuação Classificadas 2010" Visible="false">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "Criterio.QuestionarioGestaoPontuacaoAnterior") + "%"%>
                                        </ItemTemplate>
                                        <HeaderStyle Width="130px" />
                                        <FooterTemplate>
        ...
        <div>
            ...
            <table cellspacing="0" cellpadding="1" width="100%" border="1">
                <tr>
                    <td class="tdAzulEscuro" align="center" colspan="3">
                        RESULTADOS APRESENTADOS
                    </td>
                </tr>
            </table>
            <br />
            <table cellspacing="0" cellpadding="1" border="0" class="quiz" style="width: 900px;
                margin-top: 20px;">
                <tr>
                    <td class="opcao">
