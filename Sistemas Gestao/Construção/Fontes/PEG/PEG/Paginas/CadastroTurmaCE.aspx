<%@ Page Title="Turma" Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true" CodeBehind="CadastroTurmaCE.aspx.cs" Inherits="PEG.FGA.Paginas.CadastroTurmaCE" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<%@ Register Src="../User Control/UCCadastroTurmaIA.ascx" TagName="UCCadastroTurmaIA" TagPrefix="uc1" %>
<%@ Register Src="../User Control/UCVisualizaEmpresaTurmaCE.ascx" TagName="UCVisualizaEmpresaTurmaCE" TagPrefix="uc2" %>
