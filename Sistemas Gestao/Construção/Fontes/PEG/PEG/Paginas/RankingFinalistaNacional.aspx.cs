...
using PEG.User_Control;

namespace PEG.MPE.Paginas
{
    public partial class RankingFinalistaNacional : PaginaBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.UCJustificativaRanking1.atualizaGrid += this.PopulaGridRankingFinalitaNacional;
        }
        ...
        {
            this.PopulaGridRankingFinalitaNacional();
        }
