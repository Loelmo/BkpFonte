<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCHistoricoRAA.ascx.cs"
    Inherits="PEG.User_Control.UCHistoricoRAA" %>
                    ...
                    <div align="center" style="overflow: auto; height: 350px; width: 920px">
                        <asp:GridView ID="grdRelatorioRAA" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <%# String.Format("{0:0.00}", DataBinder.Eval(Container.DataItem, "AvaliacaoResponsabilidadeSocial"))%>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Avaliação Responsabilidade Social<br />
                                        100,00</HeaderTemplate>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <%# String.Format("{0:0.00}", DataBinder.Eval(Container.DataItem, "AvaliacaoInovacao"))%>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Avaliação Inovação<br />
                                        100,00</HeaderTemplate>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
