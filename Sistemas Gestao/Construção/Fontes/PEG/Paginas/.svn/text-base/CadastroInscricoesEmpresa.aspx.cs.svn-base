...
//            res &= Valida_TextBoxSenha(TxtBxSenha, TxtBxConfSenha);
        ...
        private void PopulaEstado()
        {
            ...
            foreach (EntEstado objEstado in new BllEstado().ObterEstadosPorTurma(objTurma.IdTurma, EntTipoEtapa.TIPO_ETAPA_PEG_INSCRICAO_AUTODIAGNOSTICO_EMPRESA))
            {
                item = new ListItem();
        ...
        protected void BtnProximo2_Click(object sender, EventArgs e)
        {
            ...
            else if (this.VerificaCamposObrigatoriosContato())
            {
                this.PassoAPasso(3);
            }
            else
