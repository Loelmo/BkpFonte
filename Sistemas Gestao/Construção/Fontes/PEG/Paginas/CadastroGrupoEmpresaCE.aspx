<%@ Page Title="Grupo Empresa" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="CadastroGrupoEmpresaCE.aspx.cs" Inherits="PEG.Paginas.CadastroGrupoEmpresaCE" %>
                ...
                <td>
                    <div align="center">
                        <asp:GridView ID="grdGrupo" runat="server" AllowPaging="True" AllowSorting="True"
                            PageSize="15" CssClass="Text_grid" Width="100%" DataKeyNames="IdGrupoEmpresa"
