            ...
            if (Request.QueryString["UserCD"] != null && Request.QueryString["Tipo"] != null)
            {
                ...
                if (Tipo == "Adm")
                {
                    ...
                    else
                    {
                        ...
                        WebUtils.EnviaEmail(objUsuario.Email, "Solicitação de senha PEG", sMensagem);
                ...
                else if (Tipo == "Empresa")
                {
                    ...
                    else
                    {
                        ...
                        WebUtils.EnviaEmail(objUsuario.ProgramaEmpresa.EmailResponsavel, "Solicitação de senha PEG", sMensagem);
