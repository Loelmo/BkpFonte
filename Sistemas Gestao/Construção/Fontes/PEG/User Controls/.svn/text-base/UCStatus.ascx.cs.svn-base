...
namespace PEG.User_Controls
{
    public partial class UCStatus : UCBase
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (bHistorico && bParticipa)
                    {
                        ...
                        EntEtapa objEtapa = new BllEtapa().ObterPorTipoEtapaTurmaEstado(EntTipoEtapa.TIPO_ETAPA_PEG_INSCRICAO_AUTODIAGNOSTICO_EMPRESA, this.objTurma.IdTurma, EmpresaLogada.Estado.IdEstado);
        ...
        {
            Response.Redirect("/PEG/Paginas/RelatorioRAA.aspx");
        }
    }
}