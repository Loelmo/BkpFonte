<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCExportarInscritas.ascx.cs"
    Inherits="PEG.User_Controls.UCExportarInscritas" %>
                ...
                <tr>
                    <td width="100%">
                        <asp:CheckBoxList ID="chkListCampos" TextAlign="Right" runat="server" RepeatColumns="2" Width="100%"
                            ...
                            <asp:ListItem Text="CNPJ/CPF" Value="TX_CPF_CNPJ" Selected="True" />
                            ...
                            <asp:ListItem Text="Categoria" Value="CEA_CATEGORIA" Selected="True" />
