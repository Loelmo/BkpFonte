<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVisualisaEmpresaTurmaCE.ascx.cs" Inherits="Sistema_de_Gestao.FGA.User_Controls.UCVisualisaEmpresaTurmaIA" %>
