...
<div id="divUserControl" runat="server" visible="false" valign="middle" align="center"
    ...
    <asp:Panel ID="PnlFundo" CssClass="panelUC" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvNome" runat="server" ControlToValidate="TxtNome"
                            Display="None" ErrorMessage="Nome Obrigatório!" ValidationGroup="vgInserir"
                            SetFocusOnError="true"></asp:RequiredFieldValidator>
                        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" TargetControlID="rfvNome">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtDescricao"
                            Display="None" ErrorMessage="Descrição Obrigatória!" ValidationGroup="vgInserir"
                            SetFocusOnError="true"></asp:RequiredFieldValidator>
                        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server" TargetControlID="rfvNome">
                        </cc1:ValidatorCalloutExtender>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                     ...
                     <td align="left"> 
                        <asp:RadioButtonList ID="rbTipo" runat="server" 
                            ...
                            <asp:ListItem Selected="True" Value="0">Pública</asp:ListItem>
        ...
        <div align="right">
            <br />
            <asp:ImageButton ID="ImgBttnGravar" runat="server" ValidationGroup="vgInserir"
