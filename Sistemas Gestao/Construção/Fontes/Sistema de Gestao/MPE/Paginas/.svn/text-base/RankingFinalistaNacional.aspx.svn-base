<%@ Page Title="Finalistas " Language="C#" MasterPageFile="~/Master Page/Principal.Master" AutoEventWireup="true"
    CodeBehind="RankingFinalistaNacional.aspx.cs" Inherits="Sistema_de_Gestao.MPE.Paginas.RankingFinalistaNacional" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/User Controls/UCFiltroRanking.ascx" TagName="UCFiltroRanking"
    TagPrefix="uc1" %>
<%@ Register Src="../User Control/UCJustificativaRanking.ascx" TagName="UCJustificativaRanking"
    TagPrefix="uc2" %>
                ...
                <td colspan="2">
                    <div align="center" style="overflow: auto; width: 950px">
                        <asp:GridView ID="grdRanking" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            OnRowDataBound="grdRanking_RowDataBound" 
                            OnRowUpdating="grdRanking_RowUpdating" 
                            onpageindexchanging="grdRanking_PageIndexChanging" 
                            onsorting="grdRanking_Sorting" >
