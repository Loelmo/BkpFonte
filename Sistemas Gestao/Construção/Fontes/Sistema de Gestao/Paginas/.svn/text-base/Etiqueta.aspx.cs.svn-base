    ...
    public partial class Etiqueta : PaginaBase
    {
        ...
        private void AtualizarRepeater(int pagina)
        {
            try
            {
                ...
                List<EntTurmaEmpresa> listTurmaEmpresa = new List<EntTurmaEmpresa>();

                if (ListaGridEtiqueta != null)
                {
                    if (((List<EntTurmaEmpresa>)ListaGridEtiqueta).Count > 0)
                    {
                        listTurmaEmpresa = ((List<EntTurmaEmpresa>)ListaGridEtiqueta);
                    }
                }
                ...
                pds.DataSource = listTurmaEmpresa;
                ...
                paginacao = " Total: " + listTurmaEmpresa.Count + " Pg <b>" + (pagina + 1).ToString() + "</b> de " + pds.PageCount;
