<%@ Page Title="Inscrições" Language="C#" MasterPageFile="~/Master Page/Principal.Master"
    AutoEventWireup="true" CodeBehind="InscricaoAdminCE.aspx.cs" Inherits="Sistema_de_Gestao.Paginas.InscricaoAdminCE" %>
...
<%@ Register Src="~/User Controls/UCInscricaoEmpresaIA.ascx" TagName="UCInscricaoEmpresaIA"
    TagPrefix="uc2" %>
<%@ Register Src="~/User Controls/UCHistoricoRAA.ascx" TagName="UCHistoricoRAA"
    TagPrefix="uc3" %>
    ...
    <fieldset style="width: 900px; font-size: 12px; white-space: nowrap;">
        ...
        <div id="filtroSimples">
            <table cellspacing="1" cellpadding="1" width="100%" align="center" border="0" class="tabFiltros">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label28" runat="server" Text="Grupo de Empresa:"> </asp:Label>
                    </td>
                    <td>
        ...
        <div id="filtroCompleto" runat="server" visible="false">
            <table cellspacing="1" cellpadding="1" align="center" border="0" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:DropDownList ID="ddlCategoria" runat="server" Width="255" DataValueField="IdCategoria"
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label6" runat="server" Text="Participa Programa?"> </asp:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="ChckBxParticipaPrograma" runat="server" Checked="true" />
                    </td>
                    <td>
