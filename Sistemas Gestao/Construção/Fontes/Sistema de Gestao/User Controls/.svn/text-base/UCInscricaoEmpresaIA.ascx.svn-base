<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCInscricaoEmpresaIA.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Control.UCInscricaoEmpresaIA" %>
        ...
        <fieldset class="fieldsetUC">
                                ...
                                <table cellspacing="1" cellpadding="1" width="100%" align="left" border="0">
                                    <tr>
                                        <td align="left" width="160">
                                            <asp:Label ID="Label8" runat="server" Text="CPF/CNPJ:"></asp:Label>
                                        </td>
                                        <td align="left">
            ...
            <div id="divDados" runat="server">
                ...
                <table cellspacing="1" cellpadding="1" align="left" width="100%" border="0" >
                    ...
                    <tr>
                        <td align="left" width="160">
                            <asp:Label ID="LblCNPJCPFValido" runat="server" Text="CPF/CNPJ:"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                            ...
                            <div id="divPerguntas" runat="server">
                                <table width="100%">
                                    <tr>
                                        <td align="left" colspan="3">
                                                <asp:Label ID="Label42" runat="server" Text="Você deseja concorrer ao Destaque de Empreendedorismo?:"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="60%">
                                        ...
                                        <td align="left" width="35%">
                                                <asp:RadioButtonList ID="Destaque1" runat="server" TabIndex="44" RepeatDirection="Horizontal">
                                            ...
                                            <td>
                                                <span class="obrigatorio">*</span>
                                                <asp:RequiredFieldValidator ID="rfvPergunta" runat="server" ControlToValidate="Destaque1"
                                                    InitialValue="" ErrorMessage="Resposta Obrigatória!" ValidationGroup="vgInserir"
                    ...
                    <tr>
                        <td align="left" colspan="3">
                                <asp:Label ID="Label15" runat="server" Text="Deseja concorrer nas Categorias Destaques Inovação e Responsabilidade Social? Selecione abaixo a(s) opção(ões):"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="left" >
                                ...
                                <asp:RadioButtonList ID="Destaque2" runat="server" TabIndex="45" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Selected="false">Sim</asp:ListItem>
                                    <asp:ListItem Value="0" Selected="false">Não</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td>
                                <span class="obrigatorio">*</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Destaque2"
                                    InitialValue="" ErrorMessage="Resposta Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender9" runat="server" TargetControlID="rfvPergunta">
                                </cc1:ValidatorCalloutExtender>
                    ...
                    <tr>
                        ...
                        <td align="left" >
                                ...
                                <asp:RadioButtonList ID="Destaque3" runat="server" TabIndex="46" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Selected="false">Sim</asp:ListItem>
                                    <asp:ListItem Value="0" Selected="false">Não</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td>
                                <span class="obrigatorio">*</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Destaque3"
                                    InitialValue="" ErrorMessage="Resposta Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender10" runat="server" TargetControlID="rfvPergunta">
                                </cc1:ValidatorCalloutExtender>
                ...
                <div id="divSenha" runat="server">
                    <fieldset style="margin-top: 5px; margin-left: 10px; margin-right: 10px" >
                        ...
                        <table cellspacing="1" cellpadding="1" align="left" width="100%" border="0" >
                            <tr>
                                <td align="left">
                                    <asp:Label ID="Label155" runat="server" Text="Senha:"></asp:Label>
                                </td>
                                <td align="left">
                ...
                <fieldset style="margin-top: 5px; margin-left: 10px; margin-right: 10px" >
                    ...
                    <table cellspacing="1" cellpadding="1" width="100%" align="left" border="0">
                        ...
                        <tr>
                            <td align="left">
                                <asp:Label ID="Label344" runat="server" Text="Os dirigentes têm clareza do que a empresa deverá ser no futuro?:"></asp:Label>
                            </td>
                            <td align="left">
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPergunta1" runat="server" ControlToValidate="RdBttnLstPergunta1"
                                    Display="None" ErrorMessage="Pergunta 1 Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPergunta2" runat="server" ControlToValidate="RdBttnLstPergunta2"
                                    Display="None" ErrorMessage="Pergunta 2 Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPergunta3" runat="server" ControlToValidate="RdBttnLstPergunta3"
                                    Display="None" ErrorMessage="Pergunta 3 Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPergunta4" runat="server" ControlToValidate="RdBttnLstPergunta4"
                                    Display="None" ErrorMessage="Pergunta 4 Obrigatória!" ValidationGroup="vgInserir"
                                    SetFocusOnError="true"></asp:RequiredFieldValidator>
