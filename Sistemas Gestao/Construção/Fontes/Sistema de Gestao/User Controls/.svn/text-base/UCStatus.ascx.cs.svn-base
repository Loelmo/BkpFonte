...
namespace Sistema_de_Gestao.User_Controls
{
    public partial class UCStatus : UCBase
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (bHistorico && bParticipa)
                    {
                        ...
                        EntEtapa objEtapa = new BllEtapa().ObterPorTipoEtapaTurmaEstado(EntTipoEtapa.TIPO_ETAPA_MPE_INSCRICAO_CANDIDATURA_EMPRESA, this.objTurma.IdTurma, EmpresaLogada.Estado.IdEstado);
        ...
        {
            Response.Redirect("/MPE/Paginas/RelatorioRAA.aspx");
        }
    }
}