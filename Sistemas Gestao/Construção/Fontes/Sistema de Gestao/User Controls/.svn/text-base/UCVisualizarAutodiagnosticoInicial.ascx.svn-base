<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVisualizarAutodiagnosticoInicial.ascx.cs" Inherits="Sistema_de_Gestao.User_Controls.UCVisualizarAutodiagnosticoInicial" %>
