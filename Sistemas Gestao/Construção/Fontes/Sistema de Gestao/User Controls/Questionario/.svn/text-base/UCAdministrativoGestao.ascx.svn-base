<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAdministrativoGestao.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCAdministrativoGestao" %>
        ...
        <tr>
            ...
            <td width="20%" valign="top" align="center">
                <div id="botaoProximo" runat="server">
                    <asp:ImageButton ImageUrl="/Image/_file_save.png" ID="BtnSalvar" runat="server" OnClick="BtnSalvar_Click" />
                </div>
            </td>
        </tr>
    </table>
