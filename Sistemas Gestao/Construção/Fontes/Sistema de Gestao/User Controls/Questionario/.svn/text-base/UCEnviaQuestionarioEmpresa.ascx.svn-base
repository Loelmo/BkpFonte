<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCEnviaQuestionarioEmpresa.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.Questionario.UCEnviaQuestionarioEmpresa" %>
...
<div id="divUserControl" runat="server" visible="false" valign="middle" align="center"
    ...
    <asp:Panel ID="PnlFundo" runat="server" Width="400px" Height="160px" BackColor="White"
        ...
        <table cellspacing="1" cellpadding="1" border="0" style="text-align: left;">
            <tr>
                <td colspan="2">
                    <asp:Label ID="LblEnviaQuestionario" Text=" Para enviar a sua Autoavaliação selecione o botão Enviar." runat="server" />
                    <br />
                    <asp:Label ID="Label1" Text="Após o envio para acessar o Relatório de Autoavaliação com os pontos fortes e oportunidades de melhorias para sua empresa, clique na seta “Histórico de Relatórios”." runat="server" />
                    <br />
                    <br />
                </td>
            </tr>
