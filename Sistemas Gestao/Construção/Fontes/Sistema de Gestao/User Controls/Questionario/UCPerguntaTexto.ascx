<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPerguntaTexto.ascx.cs"
    Inherits="Sistema_de_Gestao.User_Controls.UCPerguntaTexto" %>
...
<div class="divPerguntas" id="divPerguntas" style="display: block;" runat="server">
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="quiz">
        <tr>
            <td colspan="2">
                <asp:TextBox ID="TxtResposta" Rows="5" TextMode="MultiLine" runat="server" Width="99%" Font-Names="Arial" Font-Size="12px"/>
            </td>
        </tr>
    </table>
    <br clear="all" />
